    ...
    <div id="page-wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="text-white">
                                <h1 class="mb-4"><span class="text-success">Let us</span><br>
                                    Guide you Home</h1><!-- FOR MORE PROJECTS visit: .com -->
		...
		======================================================-->
            <div class="full-row bg-gray">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12"><!-- FOR MORE PROJECTS visit: .com -->
            ...
            <div class="full-row">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12"><!-- FOR MORE PROJECTS visit: .com -->
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                    <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: .com -->
                ...
                <div class="container">
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: .com -->
